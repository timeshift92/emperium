...
- Чтобы вручную прогнать tick и увидеть обновление `EconomySnapshot`, используйте `POST /api/dev/tick-now?advanceTime=true` — это удобно для быстрой отладки цен и агентов экономики.
