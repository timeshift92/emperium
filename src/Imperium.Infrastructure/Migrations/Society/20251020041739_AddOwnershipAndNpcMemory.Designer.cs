...
namespace Imperium.Infrastructure.Migrations.Society
{
    ...
    [Migration("20251020041739_AddOwnershipAndNpcMemory")]
    partial class AddOwnershipAndNpcMemory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Imperium.Domain.Models.NpcMemory", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("KnownAssets")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.PrimitiveCollection<string>("LostAssets")
                        .IsRequired()
                        .HasColumnType("TEXT");
